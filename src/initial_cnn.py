...
with tf.Session() as sess:
    ...
    # conv layer 1
    W_conv11 = weight_variable([5, 5, 1, filters1])
    ...
    # conv layer 2
    W_conv2 = weight_variable([5, 5, filters1, filters2])
    ...
    W_fc1 = weight_variable([25 * 25 * filters2, nNeuronsfc1])
    ...
    submission.to_csv('playground-second-clasif.csv', index=False)
    submission.tail()  

    mychart = pd.DataFrame(data={'accuracy': acc_time})
    mychart.to_csv('playground-second-accu.csv', index=False)
    mychart.tail() 
